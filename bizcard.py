...
icon = Image.open(r"C:\Users\CHETHU\Downloads\bizcard.jpg")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By CHETHAN",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *CHETHAN *!"""})
...
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background:url('https://wallpapers.com/images/high/colorful-plain-swirling-gradient-qqvfflbnflad1pv8.webp');
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open(r"C:\Users\CHETHU\OneDrive\Desktop\background1.jpeg"), width=500)
        st.markdown("## :grey[**Technologies Used :**] Python,easy OCR, Streamlit, SQL, Pandas")
    with col2:
        st.write(
            "## :grey[**About :**]Bizcard is a Python application designed to extract information from business cards.")
        st.write(
